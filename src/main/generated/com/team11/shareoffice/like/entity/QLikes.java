...
public class QLikes extends EntityPathBase<Likes> {
    ...
    private static final long serialVersionUID = -1263222191L;
    ...
    public final com.team11.shareoffice.post.entity.QPost post;
    ...
    public QLikes(Class<? extends Likes> type, PathMetadata metadata, PathInits inits) {
        ...
        this.post = inits.isInitialized("post") ? new com.team11.shareoffice.post.entity.QPost(forProperty("post"), inits.get("post")) : null;
    }
