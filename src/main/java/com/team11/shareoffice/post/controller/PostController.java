...
public class PostController {
    ...
    public ResponseDto<?> createPost(
        ...
        return postService.createPost(postRequestDto, imageFile, userDetails.getMember());
    }
    ...
    public ResponseDto<?> updatePost(@PathVariable Long id,
                                        ...
                                        @AuthenticationPrincipal UserDetailsImpl userDetails) throws IOException{
        postService.updatePost(id, postRequestDto, images, userDetails.getMember());
        return ResponseDto.setSuccess("성공");
    }
