...
public class JwtUtil {
    ...
    private static final long ACCESS_TOKEN_TIME = 20 * 60 * 1000L;   //AccessToken Time 1 hr = 60 * 60 * 1000L;
    private static final long REFRESH_TOKEN_TIME = 60* 60 * 1000L; //RefreshToken Time 1 day = 24 * 60 * 60 * 1000L;
