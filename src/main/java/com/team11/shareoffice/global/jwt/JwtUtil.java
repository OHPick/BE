...
public class JwtUtil {
    ...
    private static final long ACCESS_TOKEN_TIME =  60 * 1000L;   //AccessToken Time 1 hr
    private static final long REFRESH_TOKEN_TIME =  2 * 60 * 1000L; //RefreshToken Time 1 day
